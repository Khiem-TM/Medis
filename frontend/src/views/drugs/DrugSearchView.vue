        ...
        <table class="w-full text-left border-collapse">
          <thead>
            <tr class="bg-surface-container-low border-b border-outline-variant">
              ...
              <th class="px-6 py-3 text-xs font-bold text-on-surface-variant uppercase tracking-wider">Mã thuốc</th>
              <th class="px-6 py-3 text-xs font-bold text-on-surface-variant uppercase tracking-wider">Mô tả</th>
            </tr>
          </thead>
            ...
            >
              <td class="px-6 py-4">
                <div class="flex items-center gap-3">
                  ...
                  <span class="text-sm font-semibold text-on-surface group-hover:text-primary transition-colors">{{ drug.generic_name }}</span>
                </div>
              </td>
              <td class="px-6 py-4">
                <code class="px-2 py-0.5 bg-surface-container text-primary rounded text-xs font-bold">{{ drug.id }}</code>
              </td>
              <td class="px-6 py-4">
                <span class="text-sm text-on-surface-variant">{{ drug.description ?? '—' }}</span>
              </td>
            </tr>
          </tbody>
        </table>
